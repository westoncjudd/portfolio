...
<iframe src="https://homework-to-do.streamlit.app/?embed=true"
...
**Product:** Homework To-Do List App
**Platform:** Streamlit (Python 3.13+)
**Data Storage:** JSON (homework_data.json + courses_data.json or merged schema)
